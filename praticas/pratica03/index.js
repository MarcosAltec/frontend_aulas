...
function PageLogin() {
    const logo = Icone("", "Logo da Aplicação");
    const titulo = Titulo("Aluno Online");
    const form = FormLogin();
    const link = Link("/esqueceu a senha?", "Esqueceu sua Senha?");
...
function Cabecalho() {
    ...
    const icone = Icone("", "Ícone de Pesquisar");
